...
[![CI](https://github.com/PierreSenellart/provenance-lean/actions/workflows/lean.yml/badge.svg?branch=main)](https://github.com/PierreSenellart/provenance-lean/actions/workflows/lean.yml)
...
complements the description of the data model of ProvSQL provided in [Sen, Maniu &
Senellart, "ProvSQL: A General System for Keeping Track of the Provenance and
Probability of Data", ICDE 2026](https://arxiv.org/abs/2504.12058).
